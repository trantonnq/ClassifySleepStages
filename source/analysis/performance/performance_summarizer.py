from source.analysis.performance.epoch_performance import SleepWakePerformance, ThreeClassPerformance, FourClassPerformance, FiveClassPerformance
...
class PerformanceSummarizer(object):
    ...
    @staticmethod
    def average_four_class(four_class_performance_array: [FourClassPerformance]):
        average_performance = FourClassPerformance(accuracy=0,
                                                    wake_correct=0,
                                                    n1_n2_correct = 0,                                            
                                                    n3_correct = 0,
                                                    rem_correct=0,
        ...
        for four_class_performance in four_class_performance_array:
            average_performance.accuracy += four_class_performance.accuracy
            average_performance.wake_correct += four_class_performance.wake_correct
            average_performance.n1_n2_correct += four_class_performance.n1_n2_correct
            average_performance.n3_correct += four_class_performance.n3_correct
            average_performance.rem_correct += four_class_performance.rem_correct            
            average_performance.kappa += four_class_performance.kappa

        number_of_performance_models = len(four_class_performance_array)
        ...
        average_performance.n1_n2_correct = PerformanceSummarizer.__calculate_average(average_performance.n1_n2_correct,
                                                                                     number_of_performance_models)

        average_performance.n3_correct = PerformanceSummarizer.__calculate_average(average_performance.n3_correct,
                                                                                     number_of_performance_models)
    ...
    @staticmethod
    def average_five_class(five_class_performance_array: [FiveClassPerformance]):
        average_performance = FiveClassPerformance(accuracy=0,
                                                    wake_correct=0,
                                                    n1_correct = 0,
                                                    n2_correct = 0,
                                                    n3_correct = 0,
        ...
        for five_class_performance in five_class_performance_array:
            average_performance.accuracy += five_class_performance.accuracy
            average_performance.wake_correct += five_class_performance.wake_correct
            average_performance.n1_correct += five_class_performance.n1_correct
            average_performance.n2_correct += five_class_performance.n2_correct
            average_performance.n3_correct += five_class_performance.n3_correct
            average_performance.rem_correct += five_class_performance.rem_correct            
            average_performance.kappa += five_class_performance.kappa

        number_of_performance_models = len(five_class_performance_array)
        ...
        average_performance.n1_correct = PerformanceSummarizer.__calculate_average(average_performance.n1_correct,
                                                                                     number_of_performance_models)

        average_performance.n2_correct = PerformanceSummarizer.__calculate_average(average_performance.n2_correct,
                                                                                       number_of_performance_models)
