...
class TableBuilder(object):
    ...
    @staticmethod
    def print_table_five_class(classifier_summaries):
        ...
        for classifier_summary in classifier_summaries:
            ...
            for feature_set in performance_dictionary:
                ...
                five_class_performance_summary = performance_dictionary[feature_set]
                wake_correct = five_class_performance_summary.wake_correct
                n1_correct = five_class_performance_summary.n1_correct                                
                n2_correct = five_class_performance_summary.n2_correct
                n3_correct = five_class_performance_summary.n3_correct
                rem_correct = five_class_performance_summary.rem_correct
                accuracy = five_class_performance_summary.accuracy
                kappa = five_class_performance_summary.kappa

                print(str(round(wake_correct, 3)) + ' & ' +
                      str(round(n1_correct, 3)) + ' & ' +
                      str(round(n2_correct, 3)) + ' & ' +
                      str(round(n3_correct, 3)) + ' & ' +
                      str(round(rem_correct, 3)) + ' & ' +
                      str(round(accuracy, 3)) + ' & ' +
                      str(round(kappa, 3)) + '\\\\')
